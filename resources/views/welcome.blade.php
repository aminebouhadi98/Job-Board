        ...
        <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
            <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
                <div class="text-[13px] leading-[20px] flex-1 p-6 pb-12 lg:p-20 bg-white shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">
                    <h1 class="mb-3 font-extrabold text-3xl text-[#1b1b18]">Benvenuto su JobBoard!</h1>
                    <p class="mb-4 text-[#706f6c] text-base">Trova e pubblica offerte di lavoro in modo semplice e veloce.<br>Inizia subito la tua ricerca o pubblica un annuncio!</p>
                    <div class="flex gap-4 mt-8">
                        <a href="{{ route('public.jobs.index') }}" class="bg-blue-600 hover:bg-blue-700 transition text-white px-6 py-2 rounded-lg shadow font-semibold">Cerca offerte</a>
                        <a href="{{ route('register') }}" class="bg-gray-100 hover:bg-gray-200 transition text-blue-700 px-6 py-2 rounded-lg shadow font-semibold border border-blue-200">Registrati</a>
                    </div>
                </div>
            </main>
        </div>
